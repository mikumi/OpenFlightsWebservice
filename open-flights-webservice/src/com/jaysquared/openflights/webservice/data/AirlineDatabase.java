        ...
        if (!foundMatch) {
            ...
            try {
                ...
                statementBuilder.addSelectFields(
                        new String[]{FIELD_AIRLINE_ID, FIELD_NAME, FIELD_ALIAS, FIELD_IATA, FIELD_ICAO, FIELD_CALLSIGN,
                                     FIELD_COUNTRY, FIELD_ACTIVE}
                                                );
                for (final Map.Entry<String, String> entry : fields.entrySet()) {
                    if (entry.getValue().equals(NOT_NULL)) {
                        statementBuilder.addWhereNotField(entry.getKey(), "");
                ...
                while (resultSet.next()) {
                    ...
                    final Airline airline =
                            new Airline(resultAirlineId, resultName, resultAlias, resultIata, resultIcao,
